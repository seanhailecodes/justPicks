...
const FAQ_DATA: FAQSection[] = [
  {
    ...
    items: [
      {
        question: 'What is justPicks?',
        answer: "justPicks lets you track sports picks, compete with friends, and see how sharp your instincts really are — no money required. It's about the prediction, not the bet.",
      },
      {
        question: 'Do I need to bet real money to use this?',
        answer: 'Never. justPicks is 100% pick tracking. The optional wager feature is just for logging what you already did elsewhere — we never take or handle money.',
      },
      {
