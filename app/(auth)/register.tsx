          ...
          <View style={styles.form}>
            ...
            <View style={styles.disclosureCard}>
              ...
              <Text style={styles.disclosureText}>
                justPicks is not a gambling platform and does not facilitate real-money wagering of any kind. By creating an account, you acknowledge that justPicks is intended solely as a sports prediction tracking tool.{'\n\n'}
                You further acknowledge that, consistent with peer-reviewed academic research, the long-term probability of achieving a positive financial outcome through sports betting is low for the vast majority of participants. justPicks encourages you to engage with sports without gambling.
              </Text>
            </View>
            ...
            >
              ...
              <Text style={styles.termsText}>
                I am 13 or older, I understand that justPicks is not a gambling platform, and I agree to the{' '}
