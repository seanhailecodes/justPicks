    ...
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView style={styles.scroll} contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
        ...
        <Text style={styles.intro}>
          By using justPicks, you agree to these Terms of Service. Please read them carefully. If you do not agree, do not use the app.
        </Text>

        <Text style={styles.sectionTitle}>1. What justPicks Is</Text>
        <Text style={styles.body}>
          justPicks is a sports pick tracking application. It allows users to log predictions on sporting events, track their accuracy over time, and compete with friends in groups. justPicks does not facilitate, process, or enable real-money gambling of any kind. The optional wager tracking feature is a personal logging tool only — justPicks never holds, transfers, or processes funds.
        </Text>

        <Text style={styles.sectionTitle}>2. Purpose & Intended Use</Text>
        <Text style={styles.body}>
          justPicks was created with a specific and deliberate purpose: to serve as a tool that encourages users to engage with sports prediction as a skill-based activity, entirely independent of financial wagering. It is the express intent of justPicks and its operators that use of this application reduce, or altogether eliminate, a user's participation in real-money sports gambling.{'\n\n'}
          Users are hereby informed that, in the opinion of justPicks and consistent with a substantial body of peer-reviewed academic literature published in the fields of behavioral economics, psychology, and public health, the probability of achieving a sustained positive financial outcome through sports wagering is low. Research consistently demonstrates that the structural mechanics of sports betting markets — including the house margin ("juice" or "vig"), cognitive biases such as the illusion of control and outcome bias, and the inherent unpredictability of athletic competition — combine to make long-term profitable wagering statistically improbable for the overwhelming majority of participants.{'\n\n'}
          ...
          By accepting these Terms, you acknowledge that you have been informed of these findings. justPicks expressly encourages all users to treat sports prediction as entertainment and competition rather than as a source of income or financial gain. The goal of this platform is not to make you a better bettor — it is to make betting unnecessary.
        </Text>

        <Text style={styles.sectionTitle}>3. Eligibility</Text>
        <Text style={styles.body}>
          You must be at least 17 years old to use justPicks. By creating an account, you confirm that you meet this requirement. If you are under 17, please do not use the app.
        </Text>
        ...
        <Text style={styles.body}>
          You agree not to:{'\n\n'}
          • Use justPicks for any unlawful purpose{'\n'}
        ...
        <Text style={styles.body}>
          justPicks is not a gambling platform. No real money is wagered, won, or lost through justPicks. The wager tracking feature is a private, optional logging tool and does not constitute gambling. Users are solely responsible for any real-money gambling activity they engage in outside of justPicks. justPicks expressly disclaims any responsibility for such activity.
        </Text>
        ...
        <Text style={styles.sectionTitle}>8. Groups</Text>
        <Text style={styles.body}>
        ...
        <Text style={styles.body}>
          All content, design, and code within justPicks is owned by or licensed to us. You may not reproduce, distribute, or create derivative works without our written permission. You retain ownership of any content you submit (such as usernames and group names), but grant us a license to display it within the app.
        </Text>

        <Text style={styles.sectionTitle}>10. Disclaimer of Warranties</Text>
        <Text style={styles.body}>
          justPicks is provided "as is" without warranties of any kind. We do not guarantee uninterrupted service, error-free operation, or the accuracy of sports data. Use of the app is at your own risk.
        </Text>

        <Text style={styles.sectionTitle}>11. Limitation of Liability</Text>
        <Text style={styles.body}>
          To the fullest extent permitted by law, justPicks and its operators shall not be liable for any indirect, incidental, or consequential damages arising from your use of the app, including any real-money gambling losses incurred outside the app.
        </Text>

        <Text style={styles.sectionTitle}>12. Changes to These Terms</Text>
        <Text style={styles.body}>
          We may update these terms at any time. We will notify you of significant changes via the app or email. Continued use of justPicks after changes constitutes acceptance of the updated terms.
        </Text>
