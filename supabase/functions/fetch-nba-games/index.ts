...
Deno.serve(async (req) => {
  ...
  try {
    ...
    // Remove games the book de-listed since the last fetch (e.g. a now-impossible
    // conditional matchup once a prior series ends). Live set + window are taken
    // from this fetch's feed response.
