...
export const APP_SPORTS: AppSport[] = [
  ...
  { key: 'ncaaf', label: 'NCAAF',  emoji: '🏈', league: 'NCAAF', enabled: true,  displayMode: 'name', season: [8, 24, 1, 20]  },
  ...
  { key: 'boxing',label: 'Boxing', emoji: '🥊', league: 'BOXING', enabled: true,  displayMode: 'fighter'                       },
